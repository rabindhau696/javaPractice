class NumberToWord {
	final String[] special = { "", " thousand", " million", " billion", " trillion", " quadrillion", " quintillion" };
...
public class NumberToWords {
	...
	public static void main(String[] args) {
		NumberToWord myWord = new NumberToWord();
		System.out.println(myWord.convert(-21));
